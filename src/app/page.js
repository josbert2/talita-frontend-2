  ...
  return (
    <div>
        ...
        <div class="container flex h-14 items-center">
            <div class="mr-4 hidden md:flex">
                ...
                <nav class="flex items-center space-x-6 text-sm font-medium">
                    <a class="transition-colors hover:text-foreground/80 text-foreground/60" href="/docs">Documentation</a><a class="transition-colors hover:text-foreground/80 text-foreground/60" href="/docs/components">Components</a>
            ...
            <div class="flex flex-1 items-center justify-between space-x-2 md:justify-end">
                ...
                <nav class="flex items-center">
                    ...
                    >
                        ...
                        <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" class="absolute h-[1.2rem] w-[1.2rem] rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100">
                            <path
      ...
      <div class="main-content">
        <div class="px-4 py-4">
          <div class="grid grid-cols-5 gap-5 px-5 py-2">
          {menus.map((item) => {
            return (
              <Card>
                <CardHeader>
                  <Image width={300} height={300} src="https://res.cloudinary.com/redq-inc/image/upload/c_fit,q_auto:best,w_300/v1589614568/pickbazar/grocery/GreenLimes_jrodle.jpg" alt="Card Image" />
